...
object TestModels {
    ...
    fun requireMap(deviceTypeList: List<String> = listOf("phone"), isPersistent: Boolean = false, isOneShot: Boolean = false, customMap: String = "", wantUserStr: String? = null): Survey.RequireMap {
