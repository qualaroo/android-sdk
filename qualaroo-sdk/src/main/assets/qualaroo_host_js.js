...
QualarooHost.prototype = {
    ...
    notifySurveyClosed: function(surveyAlias) {
      isVertical = false;
      isScrolled = false;
      Qualaroo.surveyClosed(surveyAlias);
    },

    notifySaveSurveysInfo: function(surveysInfo) {
      Qualaroo.saveSurveysInfo(surveysInfo);
    },

    notifySurveyAnswered: function(surveyAlias) {
        Qualaroo.answeredSurvey(surveyAlias);
    },
