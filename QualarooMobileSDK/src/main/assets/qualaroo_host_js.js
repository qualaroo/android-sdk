...
if (typeof(window.QualarooMobile) === 'undefined') {
  window.QualarooMobile = {}
}

if (typeof(window.QualarooMobile) === 'undefined') {
  window.QualarooMobile = new Proxy ({}, {
...
QualarooHost.prototype = {
        ...
        if (e.target instanceof HTMLScriptElement) {
            ...
            if (scriptElement.src.match(badProtocolRegExp) != null) {
                ...
                if (url.pathname.match(/\/[r|a|s|c]\.js$/) != null) {
                  QualarooMobile.surveyUndeliveredAnswerRequest(scriptElement.src);
                }
            }
        } else {
          QualarooMobile.globalUnhandledJSError(
    ...
    reload: function() {
      QualarooMobile.reloadQualarooData();
    },
    ...
    demoScroll: function (surveyAlias) {
      ...
      if (box && !isScrolled && isOldVersion) {
        ...
        if (stuff) {
            QualarooMobile.qualarooStopScroll(surveyAlias);
      ...
      if (box && isVertical && !isScrolled) {
        QualarooMobile.qualarooStartScroll();
        setTimeout(function() {
    ...
    notifySurveyHeightChangedIfNeeded: function() {
        ...
        if (currentHeight != undefined) {
            ...
            if (currentHeight != suggestedHeight && suggestedHeight > 0) {
              QualarooMobile.surveyHeightChanged(suggestedHeight);
            }
        }
    },
    ...
    notifySurveyScreenerReady: function() {
      QualarooMobile.surveyScreenerReady();
    },

    notifySurveyShow: function() {
      QualarooMobile.surveyShow();
    },
    ...
    notifyGetSurveysInfo: function(surveysInfo) {
      QualarooMobile.getSurveysInfo(surveysInfo);
    },
